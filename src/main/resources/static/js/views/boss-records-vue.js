...
(function () {
            ...
            this.app = createApp({
                ...
                methods: {
                    ...
                    getStatusBadgeClass(status) {
                        ...
                        return statusMap[status] || 'bg-dark';
                    },
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="company-intro">
                                                        ...
                                                        <div class="intro-content" style="max-height: 300px; overflow-y: auto;">
                                                            <p>${job.brandIntroduce || '暂无公司介绍'}</p>
                                                        </div>
                                                    </div>
                                                    <div class="company-welfare mt-3" v-if="parseArray(job.brandLabels).length > 0">
                                                        <h6><i class="bi bi-gift me-2"></i>公司福利</h6>
                                                        <div class="welfare-tags">
                                                            ${this.parseArray(job.brandLabels).map(welfare => 
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" @click="viewJobDetail(job)">
                ...
                mounted() {
                    // 监听标签页切换事件
                    const bossRecordsTab = document.getElementById('boss-records-tab');
                    if (bossRecordsTab) {
                        bossRecordsTab.addEventListener('shown.bs.tab', () => {
                            this.loadJobs(0);
                        });
                    }
    ...
    // 导出类
    window.Views.BossRecordsVue = BossRecordsVue;
})();
