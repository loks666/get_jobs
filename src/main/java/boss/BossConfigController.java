...
public class BossConfigController {
    ...
    @FXML private CheckBox debuggerCheckBox;
    @FXML private TextArea sayHiTextArea;
    @FXML private TextField keywordsField;
    @FXML private TextField industryField;
    @FXML private TextField cityCodeField;
    @FXML private ComboBox<String> experienceComboBox;
    @FXML private ComboBox<String> jobTypeComboBox;
    @FXML private ComboBox<String> salaryComboBox;
    @FXML private ComboBox<String> degreeComboBox;
    @FXML private ComboBox<String> scaleComboBox;
    @FXML private ComboBox<String> stageComboBox;
    @FXML private TextField minSalaryField;
    @FXML private TextField maxSalaryField;
    @FXML private TextField waitTimeField;
    @FXML private CheckBox filterDeadHRCheckBox;
    @FXML private CheckBox enableAICheckBox;
    @FXML private CheckBox sendImgResumeCheckBox;
    @FXML private CheckBox keyFilterCheckBox;
    @FXML private CheckBox recommendJobsCheckBox;
    @FXML private CheckBox h5JobsCheckBox;
    ...
    private void loadConfig() {
        try {
            ...
            enableAICheckBox.setSelected((Boolean) bossConfig.getOrDefault("enableAI", false));
    ...
    private void handleSaveAndStart() {
        try {
            ...
            existingBossConfig.put("enableAI", enableAICheckBox.isSelected());
